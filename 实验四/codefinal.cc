...
{
    cout << "===================================================================" << endl;
    cout << setw(40) <<"活前缀文法集合" << endl;
    cout << setw(10) << "活前缀编号";
    cout << setw(10) << "文法编号1";
    cout << setw(10) << "文法编号2";
    cout << setw(12) << "活前缀位置";
    cout << setw(12) << "待识别字符";
    cout << setw(12) << "规约活前缀" << endl;
    for (int i = 0; i < liveLength; i++)
    {
        cout << setw(10) << i;
    ...
    cout << endl << "活前缀文法数目：" << liveLength << endl;
    cout << "文法长度" << wfLength << endl;
    cout << endl << endl;
}
